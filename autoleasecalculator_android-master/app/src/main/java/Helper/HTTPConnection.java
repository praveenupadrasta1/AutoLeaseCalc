...
public class HTTPConnection implements HTTPInterface {
    ...
    public HttpURLConnection doPost(String requestUrl, byte[] urlParams, boolean accessTokenRequired)
    {
        HttpURLConnection urlConnection = null;
        try {
            URL url = new URL(requestUrl);
            ...
            {
                urlConnection.setRequestProperty("Authorization", "Bearer "+Utils.getAccessToken(LeaseCalcActivity.getContext()));
            }
